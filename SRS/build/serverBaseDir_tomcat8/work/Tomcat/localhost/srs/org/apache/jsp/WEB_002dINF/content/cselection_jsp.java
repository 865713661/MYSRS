 ...
 * Generated at: 2017-07-04 09:39:45 UTC
...
public final class cselection_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<th width=\"150\" bgcolor=\"#E0FFFF\">教室</th>\r\n");
      out.write("\t\t\t\t<th width=\"\" bgcolor=\"#E0FFFF\">剩余容量</th>\r\n");
      out.write("\t\t\t\t<th width=\"130\" bgcolor=\"#E0FFFF\">老师</th>\r\n");
      ...
      out.write("\t\t\ttype:'POST',\r\n");
      out.write("\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\tdata:{ssn:aa,sectionNo:val},\r\n");
      out.write("\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\tif(data.status==\"ok\"){\r\n");
      out.write("\t\t\t\t\talert(\"添加成功！\");\r\n");
      out.write("\t\t\t\t\twindow.location.reload();\r\n");
      out.write("\t\t\t\t}else if(data.status==\"no\"){\r\n");
      out.write("\t\t\t\t\talert(\"不在选课计划中！\");\r\n");
      out.write("\t\t\t\t\twindow.location.reload();\r\n");
      out.write("\t\t\t\t\t}else if(data.status==\"two\"){\r\n");
      out.write("\t\t\t\t\t\talert(\"已经选了该课程\");\r\n");
      out.write("\t\t\t\t\t\twindow.location.reload();\r\n");
      out.write("\t\t\t\t\t\t}else if(data.status==\"cant\"){\r\n");
      out.write("\t\t\t\t\t\t\talert(\"人数已满\");\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t}\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
