...
<body>
		...
		<thead>
			<tr class="text-c">
				...
				<th width="60" bgcolor="#E0FFFF">时间</th>
				<th width="90" bgcolor="#E0FFFF">教室</th>
				<th width="150" bgcolor="#E0FFFF">上课时间(周)</th>
				<th width="" bgcolor="#E0FFFF">教师</th>
				<th width="130" bgcolor="#E0FFFF">成绩等级</th>
...
function delTranscript(){
	$.ajax({
		url:'${pageContext.request.contextPath}/sectionAction_mydelete',
		type:'POST',
		dataType : 'json',
		data:{ssn:aa,grade:bb},
		...
		success : function(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				var html = '<tr><td>'
					...
					+ '</td><td>'
					+ s.grade
					+ '</td><td><a href="javascript:void(0);"  onclick="delTranscript()">退选</a></td></tr>';
