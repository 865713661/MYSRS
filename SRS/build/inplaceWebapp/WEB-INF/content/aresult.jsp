...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 课程教师管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="aselection" data-title="教师管理" href="javascript:;">教师管理</a></li>
					<li><a data-href="addc" data-title="添加课程">添加课程</a></li>
					<li><a data-href="kselection" data-title="课程查询" href="javascript:;">课程查询</a></li>
					<li><a data-href="sselection" data-title="选课安排查询" href="javascript:;">安排查询</a></li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="aselection?name=${param.name}"></iframe>
	</div>
</div>
</section>
