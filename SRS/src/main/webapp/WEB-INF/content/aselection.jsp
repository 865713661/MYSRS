...
<body>
		...
		<thead>
			<tr class="text-c">
				...
				<th bgcolor="#E0FFFF">名字</th>
				<th  bgcolor="#E0FFFF">职位</th>
				<th  bgcolor="#E0FFFF">分科</th>
				<th></th>
				<th></th>
			</tr>
		</thead>
		...
		success : function(data) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				var html = '<tr><td>'
					...
					+ '</td><td>'
					+ p.department
					+ '</td><td><a href="addp">添加</a>'
					+ '</td><td><a href="javascript:void(0);"  onclick="delectProfessor('+ ps +')">删除</a></td></tr>';
